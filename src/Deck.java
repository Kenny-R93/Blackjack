...
public class Deck {
    ...
    public void shuffleDeck() {
        ...
        // Use Random instance to generate random number; https://www.educative.io/answers/how-to-generate-random-numbers-in-java
        Random random = new Random();
        int randomCardIndex = 0;
        int originalSize = this.deck.size(); // Gets size of deck b/c removing cards; Necessary for, for loop, to work b/c getting smaller
        // For loop giving us 52 indices of original deck
